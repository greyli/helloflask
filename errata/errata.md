...
| 9.8.2 | P361 | 代码清单9-42的倒数第四行 | `return redirect(url_for('main.show_photo', photo_id=photo_id))` | `return redirect(url_for('.show_photo', photo_id=photo_id))` | 改进，蓝本内部可以省略蓝本名称 | 18.12.18 |

...
| 5.5.4 | P166 | 第1个代码块第2行 | `u'China'` | `<Country u'China'>` | 笔误 |
| 5.5.4 | P166 | 第1个代码块第3行 | `name'Tokyo'` | `name='Tokyo'` | 笔误 | 18.9.26 |
...
| 9.13.1 | - | 9.13.1第三段最后一行 | user-name | username | 笔误 | 18.11.04 |
